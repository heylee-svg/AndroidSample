...
public class MessengerServiceActivities extends Activity {
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            Toast.makeText(MessengerServiceActivities.this, R.string.remote_service_connected, Toast.LENGTH_SHORT).show();
        }
        ...
        public void onServiceDisconnected(ComponentName className) {
            ...
            // As part of the sample, tell the user what happened.
            Toast.makeText(MessengerServiceActivities.this, R.string.remote_service_disconnected, Toast.LENGTH_SHORT).show();
        }
    };
    ...
    void doBindService() {
        ...
        bindService(new Intent(MessengerServiceActivities.this, MessengerService.class), mConnection, Context.BIND_AUTO_CREATE);
        mIsBound = true;
