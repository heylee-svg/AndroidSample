...
import com.example.android.apis.IRemoteServiceCallback
import com.example.android.apis.ISecondary
...
class Binding : Activity() {
    ...
    private val mConnection: ServiceConnection = object : ServiceConnection {
        override fun onServiceConnected(
            ...
            Toast.makeText(
                this@Binding, R.string.remote_service_connected, Toast.LENGTH_SHORT
            ).show()
        }
        ...
        override fun onServiceDisconnected(className: ComponentName) {
            ...
            // As part of the sample, tell the user what happened.
            Toast.makeText(
                this@Binding, R.string.remote_service_disconnected, Toast.LENGTH_SHORT
            ).show()
        }
    }
    ...
    private val mBindListener =
        View.OnClickListener { // Establish a couple connections with the service, binding
            // by interface names.  This allows other applications to be
            // installed that replace the remote service by implementing
            // the same interface.
            val intent = Intent(
                this@Binding, RemoteService::class.java
            )
            intent.setAction(IRemoteService::class.java.getName())
            bindService(intent, mConnection, BIND_AUTO_CREATE)
            intent.setAction(ISecondary::class.java.getName())
    ...
    private val mKillListener = View.OnClickListener {
        ...
        if (mSecondaryService != null) {
            try {
                val pid: Int = mSecondaryService?.getPid() ?: 0
                ...
                // other's processes.
//                Process.killProcess(pid) todo not work
                ...
                Toast.makeText(
                    this@Binding, R.string.remote_call_failed, Toast.LENGTH_SHORT
                ).show()
            }
        }
    }
