...
public class MenuInflateFromXml extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        int itemId = item.getItemId();// For "Title only": Examples of matching an ID with one assigned in
//                   the XML
        if (itemId == R.id.jump) {
            Toast.makeText(this, "Jump up in the air!", Toast.LENGTH_SHORT).show();
            invalidateOptionsMenu();
            return true;
        } else if (itemId == R.id.dive) {
        ...
        } else if (itemId == R.id.browser_visibility) {// The refresh item is part of the browser group
        ...
        } else if (itemId == R.id.email_visibility) {// The reply item is part of the email group
        ...
        } else {// Don't toast text when a submenu is clicked
            if (!item.hasSubMenu()) {
